        ...
        <div className="hero min-h-screen py-20">
          <div className="hero-content flex-col lg:flex-row">
            ...
            <div className="lg:ml-5">
              ...
              >
                I’m a full-stack developer at CHED Central Office, where I focus
                on creating efficient and scalable web applications. I
                specialize in JavaScript, React, and Tailwind CSS for front-end
                development, ensuring smooth and responsive user interfaces. On
                the backend, I work with pure JavaScript and utilize MySQL and
                MongoDB for database management. I’m passionate about delivering
                high-quality solutions and continuously enhancing my skills to
